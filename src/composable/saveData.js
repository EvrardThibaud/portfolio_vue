export function saveData() {
  ...
  const skills = [
    { id: 1, src: "/skills/vue_logo.png", name: "Vue.js", id: "Vue.js Logo" },
    { id: 2, src: "/skills/react_logo.png", name: "React", id: "React Logo" },
    {
      id: 3,
    ...
    { id: 5, src: "/skills/csharp_logo.png", name: "C#", id: "C# Logo" },
    { id: 6, src: "/skills/vite_logo.png", name: "Vite", id: "Vite Logo" },
    {
      id: 7,
      src: "/skills/azuredevops_logo.png",
      name: "Azure DevOps",
      id: "Azure DevOps Logo",
    },
    {
      id: 8,
    ...
    { id: 10, src: "/skills/dart_logo.png", name: "Dart", id: "Dart Logo" },
    {
      id: 11,
    ...
    { id: 13, src: "/skills/php_logo.png", name: "PHP", id: "PHP Logo" },
    {
      id: 14,
    ...
    { id: 16, src: "/skills/css_logo.png", name: "CSS", id: "CSS Logo" },
    {
      id: 17,
    ...
    { id: 19, src: "/skills/linux_logo.png", name: "Linux", id: "Linux Logo" },
    {
      id: 20,
    ...
    { id: 25, src: "/skills/sql_logo.png", name: "SQL", id: "SQL Logo" },
    {
      id: 26,
    ...
    { id: 29, src: "/skills/excel_logo.png", name: "Excel", id: "Excel Logo" },
    { id: 30, src: "/skills/html_logo.png", name: "HTML", id: "HTML Logo" },
    {
      id: 31,
